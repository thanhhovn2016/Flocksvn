...
const SignInForm = () => {
  ...
  return (
    <Box sx={{ minHeight: "60vh" }}>
      <Typography variant="h3" textAlign="center" color={"#000"} gutterBottom>
        {t?.sign_in}
      </Typography>
          ...
          >
            <Grid container spacing={2} pb={2}>
              <Grid item md={12} xs={12}>
                ...
                {auth.errors && auth.errors.code == "verification_failed" && (
              ...
              <Grid item md={12} xs={12}>
                <Divider
                  light
                  sx={{ fontSize: 12, color: "#31313180", fontWeight: "bold" }}
                >
                  {t.sign_in_email}
                </Divider>
              </Grid>
