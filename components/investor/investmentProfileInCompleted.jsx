...
const InvestmentProfileInCompleted = () => {
        ...
        <Paper>
          <Box py={5} textAlign="center">
            ...
            <Typography
              ...
              py={1}
            >
              {t?.investor_profile_in_completed}
            </Typography>
            <Typography
              variant="body1"
              gutterBottom
            ...
            >
              {t?.investor_profile_in_completed_message}
            </Typography>
...
export default InvestmentProfileInCompleted;
