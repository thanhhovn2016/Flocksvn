    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        <Toolbar>
          ...
          <Box display="grid" justifyContent={"flex-end"} width="100%">
            <Avatar alt={user?.firstName} src={mediaBaseURL + user?.avatar?.url} />
          </Box>
        </Toolbar>
      </AppBar>
      <Drawer
      ...
      >
        ...
        <List>
          ...
          <Link href={"/"}>
            <ListItem key={"flocks AI"} disablePadding onClick={handleDrawerCloseMobile}>
              <ListItemButton>
                <ListItemIcon>
                  <Web />
                </ListItemIcon>
      ...
      <Main open={open}>
        <DrawerHeader />
        <Box
          paddingLeft={isMobile ? (open ? "0" : "15rem") : "0"}
          sx={{ backgroundColor: "#f5f5f5", minHeight: "calc(100vh - 136px)" }}
        >
          {props?.children}
        </Box>
      </Main>
